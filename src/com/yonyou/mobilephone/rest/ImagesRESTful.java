...
public class ImagesRESTful {
	...
	@POST   
	@Path("/users")  
	public String add_user_portrait(@HeaderParam ("img_group") String img_group,@HeaderParam ("img_type") String img_type,@HeaderParam ("related_id") int related_id,@HeaderParam ("file_type") String file_type,@Context HttpServletRequest request) throws IOException {  
